      ...
      <div className="relative overflow-hidden bg-gray-50 pt-20 md:pt-24">
        ...
        <div className="relative z-10 pb-4 px-6 max-w-7xl mx-auto">
          ...
          <p className="text-gray-700 leading-relaxed max-w-2xl text-sm md:text-lg text-justify [hyphens:auto]">
            Las siluetas de running y gym más buscadas del mercado. Réplica premium con amortiguación y acabados de nivel — a un precio que tiene sentido para Urabá. Despacho con Ruta del Golfo a toda la región de Urabá. Pago contraentrega.
          </p>
        </div>
      </div>
