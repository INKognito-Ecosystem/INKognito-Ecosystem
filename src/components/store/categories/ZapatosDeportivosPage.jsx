...
export function meta() {
  ...
  const description = 'Zapatillas para correr y entrenar en Chigorodó, Apartadó y toda la región de Urabá. Nike, Adidas, Asics y New Balance réplica premium. Envío en 1 a 4 días hábiles.'
  return [
    { title },
