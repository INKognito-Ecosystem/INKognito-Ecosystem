    ...
    <>
      ...
      <div className="bg-gray-50 pt-20 md:pt-24">
        <div className="pb-6 px-6 max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black uppercase leading-none mb-3 text-gray-900">Zapatos<br />Casuales</h1>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {loading ? <p className="text-gray-400 col-span-4 py-8 text-center">Cargando...</p>
              ...
              : catalogItems.map(item => {
                  ...
                  return <StoreProductCard key={item.name} product={prod} category="zapatos-casuales" sizes={sizes.length ? sizes : SHOE_SIZES} />
                })}
          </div>
        </div>
      </div>
