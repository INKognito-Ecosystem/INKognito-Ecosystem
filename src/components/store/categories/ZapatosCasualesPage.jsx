...
export function meta() {
  ...
  const description = 'Zapatos casuales de calidad en Chigorodó y Urabá. Modelos icónicos para el día a día. Entrega con Eljach a toda la región. Pago contraentrega.'
  return [
    { title },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Sí. Despachamos con Eljach Mensajería Express, ruta diaria a toda la zona de Urabá. Entrega estimada de 1 a 2 días hábiles a Chigorodó, Carepa, Apartadó y Turbo. Pago contraentrega: pagas cuando recibes, sin adelantos.',
  },
  {
