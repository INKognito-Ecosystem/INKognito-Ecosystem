...
export async function loader() {
  return fetchCatalogCategoriaItems('store', 'Ropa General')
}
...
export default function RopaGeneralPage() {
  ...
  const { items: catalogItems, hasMore: hayMasProductos, loading: cargandoMasProductos, loadMore: cargarMasProductos } =
    useLoadMore('store', { categoria: 'Ropa General' }, { items: itemsIniciales, nextCursor, hasMore })
      ...
      <div className="relative overflow-hidden bg-gray-50 pt-20 md:pt-24">
        ...
        <div className="relative z-10 pb-4 px-6 max-w-7xl mx-auto">
          ...
          <p className="text-gray-700 leading-relaxed max-w-2xl text-sm md:text-lg text-justify [hyphens:auto]">
            Prendas cómodas y versátiles para el día a día — pantalones, camisetas, camisas y ropa de estilo urbano, con la misma calidad que ya conoces en INKognito Store. Despacho con Ruta del Golfo a toda la región de Urabá — pagas cuando recibes.
          </p>
        </div>
      </div>
