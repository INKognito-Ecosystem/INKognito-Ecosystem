...
const products = [
  { id: 1, name: 'Leggings Running Pro', brand: 'Nike', price: '$89.000', tag: 'Running' },
  { id: 2, name: 'Conjunto Yoga Elite', brand: 'Adidas', price: '$119.000', tag: 'Yoga & Pilates' },
  { id: 3, name: 'Short Running Mujer', brand: 'Nike', price: '$65.000', tag: 'Running' },
  { id: 4, name: 'Top Deportivo Push-Up', brand: 'Under Armour', price: '$69.000', tag: 'Gym' },
  { id: 5, name: 'Conjunto Ciclismo Dama', brand: 'Adidas', price: '$135.000', tag: 'Ciclismo' },
  { id: 6, name: 'Licra Compresión Mujer', brand: 'Nike', price: '$95.000', tag: 'Compresión' },
  { id: 7, name: 'Set Gym Premium Dama', brand: 'Puma', price: '$149.000', tag: 'Training' },
  { id: 8, name: 'Capri Deportivo', brand: 'Adidas', price: '$75.000', tag: 'Multideporte' },
]
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Manejamos tallas S, M, L, XL y XXL. Como las medidas pueden variar, te recomendamos escribirnos con tu talla habitual y tus medidas de cintura y cadera para orientarte correctamente antes del pedido.',
  },
  {
  ...
  return (
    <>
      ...
      <div className="bg-black py-16 px-6 text-center">
        <a
          href="https://wa.me/573207911013?text=Hola,%20quiero%20ver%20el%20catálogo%20completo%20de%20ropa%20deportiva%20dama"
          target="_blank"
