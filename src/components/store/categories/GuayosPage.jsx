  ...
  return (
    <>
      <Seo
        ...
        description="Guayos de fútbol para canchas de Urabá. Terreno firme y canchita de sintético. Entrega con Eljach a Chigorodó, Apartadó, Carepa y Turbo. Pago contraentrega."
