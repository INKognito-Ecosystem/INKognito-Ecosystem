...
export const PRIVACIDAD_ARTISTAS_TITLE = 'Política de Privacidad — Tattoo Artist Colombia'
export const PRIVACIDAD_ARTISTAS_UPDATED = '6 de agosto de 2026'
...
export function meta() {
  return [
    { title: `${PRIVACIDAD_ARTISTAS_TITLE} | INKognito` },
...
export function PrivacidadArtistasContent() {
  return (
    <>
      <div>
...
export default function PrivacidadArtistasPage() {
  return (
    <LegalPage title={PRIVACIDAD_ARTISTAS_TITLE} updated={PRIVACIDAD_ARTISTAS_UPDATED} theme="light">
      <PrivacidadArtistasContent />
    </LegalPage>
  )
}
