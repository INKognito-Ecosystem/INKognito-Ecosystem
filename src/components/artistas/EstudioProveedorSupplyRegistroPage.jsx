...
export default function EstudioProveedorSupplyRegistroPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      <NavbarCategory pageName="Registrar proveedor" />
      ...
      {enviado ? (
        ...
        <div className="flex-1 pt-20 md:pt-24 max-w-md mx-auto px-4 pb-16 w-full">
          <h1 className="text-xl font-black uppercase mb-2 text-center">Regístrate como proveedor</h1>
          ...
          <form onSubmit={enviar} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-[10px] mt-1">Te mandamos un link para confirmar el catálogo y empezar a vender — sin esto no queda activo.</p>
            </div>
