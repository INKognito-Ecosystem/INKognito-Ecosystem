...
// Autoregistro público de estudio (fase 3 del directorio, 2026-08-06,
// Jose: "que los estudios se registren es lo que hará que los artistas
// también lo hagan") — calcado de ArtistaRegistroPage.jsx: mismo
// honeypot + captcha aritmético, mismo criterio de "correo verificado es
// el único filtro anti-spam, sin revisión manual". Versión de una sola
// columna (sin la vista previa en vivo del registro de artista) — el
// estudio completa el resto (logo/portada más grandes, invitar equipo)
// desde su propio dashboard una vez activo.
...
export function meta() {
  const title = 'Registra tu estudio | Tattoo Artist Colombia'
  const description = 'Registra tu estudio de tatuajes e invita a los artistas de tu equipo a unirse al buscador de toda Colombia.'
  return [
    { title },
    { name: 'description', content: description },
    { tagName: 'link', rel: 'canonical', href: `${import.meta.env.VITE_SITE_URL}/tattoo-artist-colombia/estudio/unete` },
  ]
}
...
export default function EstudioRegistroPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      <NavbarArtistas titulo="Registrar estudio" />
...
const SLOTS_ESTUDIO_REG = [{ key: 'logo_url' }, { key: 'foto_portada' }]
