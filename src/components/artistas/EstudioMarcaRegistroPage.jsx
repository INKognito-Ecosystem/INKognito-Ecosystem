      ...
      {enviado ? (
        ...
        <div className="flex-1 pt-20 md:pt-24 max-w-2xl mx-auto px-4 pb-16 w-full">
          ...
          {/* Jerarquía en tarjetas (2026-09-17, Jose: "organiza todos los
              ...
              sea súper claro de entender") — mismo patrón que
              EstudioRegistroPage.jsx: "Datos de la marca" agrupa lo propio
              del negocio, "Contacto y redes" agrupa
              WhatsApp/correo/Instagram/Facebook. */}
          <form onSubmit={enviar}>
            {/* CARD 1 — Datos de la marca */}
            <div className={cardClass}>
              <h2 className={cardTitleClass}>Datos de la marca</h2>
