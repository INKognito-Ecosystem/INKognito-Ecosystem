        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <Link to="/gym/maquinas-pedido" className="uppercase text-sm tracking-[0.2em] text-zinc-500 hover:text-zinc-900 transition-all duration-300">
                Máquinas bajo pedido
              </Link>
              <a href="/gym#planos" onClick={goToPlanos} className="uppercase text-sm tracking-[0.2em] text-zinc-500 hover:text-zinc-900 transition-all duration-300">
                Planos digitales
              </a>
              <Link to="/gym/tutoriales" className="uppercase text-sm tracking-[0.2em] text-zinc-500 hover:text-zinc-900 transition-all duration-300">
                Tutoriales en video
              </Link>
              <Link to="/gym/cursos" className="uppercase text-sm tracking-[0.2em] text-zinc-500 hover:text-zinc-900 transition-all duration-300">
                Cursos
              </Link>
              <Link to="/gym/recursos" className="uppercase text-sm tracking-[0.2em] text-zinc-500 hover:text-zinc-900 transition-all duration-300">
                Recursos gratis
              </Link>
