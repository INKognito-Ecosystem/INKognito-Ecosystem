        ...
        <div className="mb-0">
          ...
          <div className="flex items-center justify-center md:justify-between gap-3 md:gap-4 mb-4">
            <h1 className="text-xl md:text-7xl font-black uppercase leading-tight md:leading-none text-center md:text-left">
              Tutoriales <span className="text-zinc-500">en video</span>
            </h1>
            <PlayCircle size={40} className="text-zinc-300 flex-shrink-0 md:hidden" strokeWidth={1} />
          </div>
          <div className="flex flex-col md:flex-row md:items-end gap-6">
            ...
            <a
              ...
              className="shrink-0 border border-zinc-300 text-zinc-700 text-xs font-bold uppercase tracking-[0.2em] py-3 px-5 rounded hover:border-zinc-600 hover:text-zinc-900 transition-all duration-300"
            >
              Ver canal completo
            </a>
          </div>
      ...
      <div className="pb-8 md:pb-14 px-4 md:px-6 max-w-7xl mx-auto pt-6 md:pt-8">
        <div className="flex md:grid md:grid-cols-3 lg:grid-cols-4 gap-3 overflow-x-auto snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0 pb-2 md:pb-0 scrollbar-hide">
          {videos.map((v) => (
            <div
              key={v.id}
              className="snap-start flex-shrink-0 w-[70vw] md:w-auto border border-zinc-200 bg-white rounded-xl overflow-hidden hover:border-zinc-400 transition-all duration-300"
            >
