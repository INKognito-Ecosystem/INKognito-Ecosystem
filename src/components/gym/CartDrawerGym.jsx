...
// CartDrawerGym.jsx (2026-09-20, Jose: "el carrito también deberás
...
// mismo acento grafito (zinc-700) que Suple.
        ...
        <div className="relative flex items-center justify-between gap-3 px-6 py-5 border-b border-zinc-200 flex-shrink-0">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-zinc-400 text-xs">INKognito Gym System</p>
