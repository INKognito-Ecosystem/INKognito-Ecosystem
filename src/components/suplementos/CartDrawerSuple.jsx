...
export default function CartDrawerSuple({ open, onClose }) {
  const { items, removeItem, changeQty, clearCart, total, count } = useSupleCart()
  ...
  const buildWhatsAppMessage = () => {
    ...
    const msg = [
      'Hola, quiero hacer un pedido en INKognito Suple:',
      '',
      ...lines,
      '',
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-800 flex-shrink-0">
          <div>
            <p className="uppercase tracking-[0.25em] text-gray-500 text-xs mb-0.5">INKognito Suple</p>
