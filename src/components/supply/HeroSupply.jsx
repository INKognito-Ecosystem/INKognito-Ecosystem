export default function HeroSupply() {
  ...
  return (
    ...
    <section className="min-h-screen pt-2 md:pt-32 bg-black text-white flex items-center px-6">
      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mt-10">
            ...
            <button className="px-6 py-3 border border-blue-500 text-white uppercase tracking-widest text-sm hover:bg-blue-500 transition-all duration-300">
              Maquinas
            </button>
