...
const products = [
  { id: 1, name: 'Tattoo Butter', brand: 'Hustle Butter', price: '$18' },
  { id: 2, name: 'Healing Balm', brand: 'After Inked', price: '$15' },
  { id: 3, name: 'Tattoo Foam', brand: 'TattooMed', price: '$12' },
  { id: 4, name: 'Care Cream', brand: 'Pegasus', price: '$10' },
  { id: 5, name: 'Recovery Gel', brand: 'InkTrox', price: '$14' },
  { id: 6, name: 'Tattoo Lotion', brand: 'Hornet', price: '$11' },
]
...
export default function AftercarePage() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <NavbarCategory pageName="Aftercare" />
