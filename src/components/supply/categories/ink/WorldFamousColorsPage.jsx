...
export default function WorldFamousColorsPage() {
  ...
  const { items: products, hasMore: hasMoreProductos, loading: cargandoMasProductos, loadMore: cargarMasProductos } = useLoadMore('supply', { marca: 'world-famous' }, { items: productosIniciales, nextCursor, hasMore })
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-28 md:pt-32 pb-24 px-4 md:px-6 max-w-7xl mx-auto">
        ...
        <BrandCatalogSection brandName="World Famous" products={products} hasMore={hasMoreProductos} onLoadMore={cargarMasProductos} loadingMore={cargandoMasProductos} />
