...
const products = [
  { id: 1, name: 'EZ Cartridge',      brand: 'EZ Tattoo', link: '/supply/cartridges/ez-tattoo' },
  { id: 2, name: 'WJX Pro Cartridge', brand: 'WJX',       link: '/supply/cartridges/wjx' },
  { id: 3, name: 'Kwadron',           brand: 'Kwadron',   link: '/supply/cartridges/kwadron' },
]
