        ...
        <div className="flex md:grid md:grid-cols-4 lg:grid-cols-7 gap-4 overflow-x-auto snap-x snap-mandatory -mx-6 px-6 md:mx-0 md:px-0 pb-2 md:pb-0 scrollbar-hide">
          {brands.map((brand) => (
            <Link
              key={brand.name}
              to={brand.to}
              className="snap-start flex-shrink-0 w-[44vw] md:w-auto h-36 border border-blue-500 bg-black flex items-center justify-center hover:bg-blue-500/10 transition-all duration-300"
            >
